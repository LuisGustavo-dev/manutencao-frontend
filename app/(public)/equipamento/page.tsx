...
// (Importe seus hooks reais. Estou usando mocks locais abaixo)
// import { useAuthRole } from '@/lib/useMockAuth';
// import { useEquipmentStatus } from '@/lib/useMockStatus';
...
// --- 1. NOVAS IMPORTAÇÕES DOS FORMULÁRIOS ---
...
// --- (MOCKS - Substitua pelos seus hooks reais) ---
...
// O componente principal precisa estar em Suspense
...
function EquipamentoPage() {
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
      <main className="max-w-6xl mx-auto p-4 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                {userRole === 'Cliente' && (
                  <>
                    {status === 'Disponível' ? (
                      ...
                      <Button variant="outline" size="lg" className="w-full" onClick={() => router.push(`/dashboard/ordens-servico-detalhe?id=${osAtiva?.id}`)}>
            ...
            {/* CARD DE FICHA TÉCNICA (Design com Ícones) */}
            <Card>
              <CardHeader>
      ...
      {/* Conteúdo do Modal (controlado por state) */}
