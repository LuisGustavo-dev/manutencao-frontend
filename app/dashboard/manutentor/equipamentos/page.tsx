...
// (Você precisará criar esta pasta e copiar os componentes para ela)
...
export default function ManutentorEquipamentosPage() {
  ...
  const filteredEquipamentos = mockEquipamentos.filter(eq => {
    // (Lógica de filtro idêntica à do Admin)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        {/* O Manutentor não pode criar novos equipamentos */}
      </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      {/* O Manutentor pode não ter permissão para editar */}
