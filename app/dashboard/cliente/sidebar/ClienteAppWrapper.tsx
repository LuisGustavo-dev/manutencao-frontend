...
import ClienteNavbar from "./ClienteNavbar" // <-- Importa a Navbar local
...
interface AppWrapperProps {
  children: ReactNode;
  sidebar: ReactNode; // A ClienteSidebar será injetada aqui
}

export function ClienteAppWrapper({ children, sidebar }: AppWrapperProps) {
    const { token } = useAuth()
        ...
        <SidebarProvider>
            <div className="flex h-screen w-screen">
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    <ClienteNavbar /> {/* Renderiza a Navbar local do Cliente */}
