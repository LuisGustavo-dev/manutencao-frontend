...
export function NewEquipmentModalContent({
  clientes,
  onClose,
}: NewEquipmentModalProps) {
  // O estado agora usa o tipo 'Omit'
  const [formData, setFormData] =
    useState<Omit<Equipamento, "nome">>(initialFormData);
  const [isLoading, setIsLoading] = useState(false);
  const { token } = useAuth();

  // O 'field' agora usa o 'keyof Omit<...>'
  const handleChange = (
    field: keyof Omit<Equipamento, "nome">,
    value: string
  ) => {
  ...
  const handleSubmit = async () => {
    ...
    const apiBody = {
      ...
      tipoValvula: formData.tipoValvula,
      ...
      <div className="grid grid-cols-2 gap-4 py-4 max-h-[60vh] overflow-y-auto pr-2">
        ...
        <div className="col-span-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              handleChange("clienteId", value === "none" ? "" : value)
            }
          >
        ...
        <div className="col-span-2">
          ...
          <Input
            ...
            placeholder="Ex: Congelamento de pão de queijo"
          />
        </div>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <Select
            value={formData.tipo}
            onValueChange={(value) => handleChange("tipo" as any, value)}
          >
            <SelectTrigger id="tipo">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="Tunel de congelamento">
                Túnel de congelamento
              </SelectItem>
              <SelectItem value="Camara de congelado">
                Câmara de congelado
              </SelectItem>
              <SelectItem value="Camara de resfriado">
                Câmara de resfriado
              </SelectItem>
        ...
        <h4 className="col-span-2 mt-4 font-semibold text-lg border-b pb-2">
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <Input
            id="compressor"
            value={formData.modeloCompressor}
            onChange={(e) => handleChange("modeloCompressor", e.target.value)}
          />
        </div>
        <div className="col-span-2 sm:col-span-1">
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <Input
            ...
            onChange={(e) => handleChange("tipoOleo", e.target.value)}
          />
        </div>
        <div className="col-span-2 sm:col-span-1">
          ...
          <Input
            id="condensador"
            value={formData.tipoCondensador}
            onChange={(e) => handleChange("tipoCondensador", e.target.value)}
          />
        </div>
        <div className="col-span-2 sm:col-span-1">
          ...
          <Input
            id="evaporador"
            value={formData.tipoEvaporador}
            onChange={(e) => handleChange("tipoEvaporador", e.target.value)}
          />
        </div>
        <div className="col-span-2 sm:col-span-1">
          ...
          <Input
            ...
            onChange={(e) => handleChange("tipoValvula", e.target.value)}
          />
        </div>
      </div>
